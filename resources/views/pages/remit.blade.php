...
@section('content')
    <div class="content-panel">
        <div class="content-panel-heading"> Send Money</div>
        <div class="content-panel-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="transaction_code" class="form-control" id="transaction_code" disabled="disabled">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="col-md-12">
                        <button class="btn btn-green" type="button" id="btn-submit">Send</button>
                    </div>
                </div>
            </div>
        </div>
